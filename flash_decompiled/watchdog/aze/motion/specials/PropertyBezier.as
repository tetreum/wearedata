            ...
            while (index < last) {
                ...
                if (this.through){
                    if (!(this.length)){
                        ...
                        this.segments[_local9] = new BezierSegment(p0, (p1 - auto), p1);
                    };
                    _local9 = this.length++;
                    this.segments[_local9] = new BezierSegment(p1, (p1 + auto), p2);
                    auto = (p2 - (p1 + auto));
                } else {
                    if (index != last){
                        p2 = ((p1 + p2) / 2);
                    ...
                    _local9 = this.length++;
                    this.segments[_local9] = new BezierSegment(p0, p1, p2);
                };
            };
            this.fvalue = null;
            if (reverse){
