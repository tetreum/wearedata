package wd.d3.material {
    ...
    public class MonumentPass extends MaterialPassBase {
        ...
        public function MonumentPass(tex:BitmapTexture){
            this.mVarsV = new <Number>[30, 30, 30, 0.06];
            this.waveVars = new <Number>[30, 30, 30, 30];
            this.mVarsV2 = new <Number>[3, 0.05, 0, 1];
        ...
        override function render(renderable:IRenderable, stage3DProxy:Stage3DProxy, camera:Camera3D, lightPicker:LightPickerBase):void{
            ...
            this.radius = (Simulation.instance.cameraTargetPos.y + 2000);
            ...
            context.setProgramConstantsFromVector(Context3DProgramType.FRAGMENT, 0, this.mVarsV);
            context.setProgramConstantsFromVector(Context3DProgramType.FRAGMENT, 1, this.mVarsF2);
