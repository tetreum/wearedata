package wd.d3.geom.objects.networks {
    ...
    public class NetworkPass extends MaterialPassBase {
        ...
        private var _triangleRenderCount:Number = 1;
        private var _triangleRenderStart:Number = 0;

        public function NetworkPass(color:int, thickness:Number){
        ...
        override function render(renderable:IRenderable, stage3DProxy:Stage3DProxy, camera:Camera3D, lightPicker:LightPickerBase):void{
            ...
            context.drawTriangles(renderable.getIndexBuffer(stage3DProxy), int((this._triangleRenderStart * renderable.numTriangles)), int((this._triangleRenderCount * renderable.numTriangles)));
        }
