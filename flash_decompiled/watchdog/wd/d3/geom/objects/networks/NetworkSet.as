package wd.d3.geom.objects.networks {
    ...
    public class NetworkSet extends Entity implements IRenderable {
        ...
        public function NetworkSet(thickness:Number=1, material:NetworkMaterial=null){
            super();
        ...
        public function get alpha():Number{
            return ((this._material as NetworkMaterial).alpha);
        }
        public function set alpha(value:Number):void{
            (this._material as NetworkMaterial).alpha = value;
        }
