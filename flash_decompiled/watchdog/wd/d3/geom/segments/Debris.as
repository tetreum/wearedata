package wd.d3.geom.segments {
    ...
    public class Debris extends ObjectContainer3D {

        public static var instance:Debris;
        ...
        public function Debris(bottomColor:int=0, topcolor:int=0x707070, thickness:Number=1){
            super();
