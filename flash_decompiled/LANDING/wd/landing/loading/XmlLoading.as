package wd.landing.loading {
    ...
    public class XmlLoading extends EventDispatcher {
        ...
        private static var _oI:XmlLoading;
        public static var XML_IS_READY:String = "xml is ready to use";

        private var _xml:XML;
        public var isComplete:Boolean = false;

        public function XmlLoading(_arg1:PrivateConstructorAccess):void{
        }
        public static function getInstance():XmlLoading{
            if (!_oI){
                _oI = new XmlLoading(new PrivateConstructorAccess());
            };
            return (_oI);
        }
