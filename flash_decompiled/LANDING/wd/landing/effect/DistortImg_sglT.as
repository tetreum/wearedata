package wd.landing.effect {
    ...
    public class DistortImg_sglT extends EventDispatcher {
        ...
        public function DistortImg_sglT(_arg1:SingletonEnforcer){
            if (!_arg1){
        ...
        public function startEffect(_arg1:DisplayObjectContainer, _arg2:Number=0):void{
            this._mcItemToDistort = _arg1;
            this.incrNormal = 0;
            this.level = LOW;
            this.setStaticLow();
            this.staticTimes = 60;
            this._timerEffect.reset();
            this._timerEffect.repeatCount = _arg2;
            this._timerEffect.start();
        }
        public function stopEffect():void{
            this._timerEffect.stop();
        }
        private function displayStatic(_arg1:TimerEvent=null):void{
            this.staticTimes--;
